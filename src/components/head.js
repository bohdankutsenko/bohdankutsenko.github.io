...
import favicon from '@images/favicons/logo.png';
import ogImage from '@images/og.png';
import appleIcon57x57 from '@images/favicons/logo.png';
import appleIcon60x60 from '@images/favicons/logo.png';
import appleIcon72x72 from '@images/favicons/logo.png';
import appleIcon76x76 from '@images/favicons/logo.png';
import appleIcon114x114 from '@images/favicons/logo.png';
import appleIcon120x120 from '@images/favicons/logo.png';
import appleIcon144x144 from '@images/favicons/logo.png';
import appleIcon152x152 from '@images/favicons/logo.png';
import appleIcon180x180 from '@images/favicons/logo.png';
import androidIcon192x192 from '@images/favicons/logo.png';
import favicon32x32 from '@images/favicons/logo.png';
import favicon96x96 from '@images/favicons/logo.png';
import favicon16x16 from '@images/favicons/logo.png';
import msIcon144x144 from '@images/favicons/logo.png';
